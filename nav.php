...
<div style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:16px;">
  <a href="/santi_assessment/index.php">Dashboard</a>
  <a href="/santi_assessment/pages/clients_list.php">Clients</a>
  <a href="/santi_assessment/pages/services_list.php">Services</a>
